...
void bobaru_F3_eval(int l_edge,
/*Inputs:*/
...
void bobaru_F3_eval_wr(int l_edge, const real_t * restrict in, real_t * restrict out) {
   bobaru_F3_eval(l_edge,in, in+(int)(2), in+(int)(2)+(int)(1), in+(int)(2)+(int)(1)+(int)(1), in+(int)(2)+(int)(1)+(int)(1)+(int)(6), 
out, out+(int)(36));
}

void kmap_bobaru_F30(int * edge, int l_edge, int * verts, int * n, int * dim) {
  int i;
  *dim = 2;
  *n = (int)((int)(1));
  if(edge) {
...
void kmap_bobaru_F31(int * edge, int l_edge, int * verts, int * n, int * dim) {
  int i;
  *dim = 1;
  *n = (int)((int)(1));
  if(edge) {
...
void kmap_bobaru_F32(int * edge, int l_edge, int * verts, int * n, int * dim) {
  int i;
  *dim = 2;
  *n = (int)((int)(3));
  if(edge) {
