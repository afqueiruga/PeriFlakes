...
void Silling_rational_0_1_eval(int l_edge,
/*Inputs:*/
...
void Silling_rational_0_1_eval_wr(int l_edge, const real_t * restrict in, real_t * restrict out) {
   Silling_rational_0_1_eval(l_edge,in, in+(int)(l_edge + 1), in+(int)(l_edge + 1)+(int)(1), in+(int)(l_edge + 1)+(int)(1)+(int)(1), in+(int)(l_edge + 1)+(int)(1)+(int)(1)+(int)(1), in+(int)(l_edge + 1)+(int)(1)+(int)(1)+(int)(1)+(int)(l_edge + 1), 
out, out+(int)(pow(l_edge + 1, 2)));
}

void kmap_Silling_rational_0_10(int * edge, int l_edge, int * verts, int * n, int * dim) {
  int i;
  *dim = 2;
...
void kmap_Silling_rational_0_11(int * edge, int l_edge, int * verts, int * n, int * dim) {
  int i;
  *dim = 1;
  *n = (int)((int)(1));
  if(edge) {
...
void kmap_Silling_rational_0_12(int * edge, int l_edge, int * verts, int * n, int * dim) {
  int i;
  *dim = 1;
  *n = (int)((int)((1.0L/2.0L)*l_edge - 1.0L/2.0L));
  if(edge) {
...
kernel_t kernel_Silling_rational_0_1 = {
.nmap = 3,
.maps = {
kmap_Silling_rational_0_10,
kmap_Silling_rational_0_11,
kmap_Silling_rational_0_12
},
...
.eval=Silling_rational_0_1_eval_wr,
.name="Silling_rational_0_1"
};
