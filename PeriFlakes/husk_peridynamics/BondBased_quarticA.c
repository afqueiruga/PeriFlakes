...
void BondBased_quarticA_eval(int l_edge,
/*Inputs:*/
...
void BondBased_quarticA_eval_wr(int l_edge, const real_t * restrict in, real_t * restrict out) {
   BondBased_quarticA_eval(l_edge,in, in+(int)(l_edge + 1), in+(int)(l_edge + 1)+(int)(1), in+(int)(l_edge + 1)+(int)(1)+(int)(1), in+(int)(l_edge + 1)+(int)(1)+(int)(1)+(int)(1), in+(int)(l_edge + 1)+(int)(1)+(int)(1)+(int)(1)+(int)(l_edge + 1), 
out, out+(int)(pow(l_edge + 1, 2)));
}

void kmap_BondBased_quarticA0(int * edge, int l_edge, int * verts, int * n, int * dim) {
  int i;
  *dim = 2;
...
void kmap_BondBased_quarticA1(int * edge, int l_edge, int * verts, int * n, int * dim) {
  int i;
  *dim = 1;
  *n = (int)((int)(1));
  if(edge) {
...
void kmap_BondBased_quarticA2(int * edge, int l_edge, int * verts, int * n, int * dim) {
  int i;
  *dim = 1;
  *n = (int)((int)((1.0L/2.0L)*l_edge - 1.0L/2.0L));
  if(edge) {
...
kernel_t kernel_BondBased_quarticA = {
.nmap = 3,
.maps = {
kmap_BondBased_quarticA0,
kmap_BondBased_quarticA1,
kmap_BondBased_quarticA2
},
...
.eval=BondBased_quarticA_eval_wr,
.name="BondBased_quarticA"
};
