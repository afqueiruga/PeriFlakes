...
void Oterkus2_rational_0_1_eval(int l_edge,
/*Inputs:*/
...
m[0]+= alpha[i - 1]*sqrt(pow(-x[0] + x[2*i], 2) + pow(-x[1] + x[2*i + 1], 2))*((sqrt(pow(-x[0] + x[2*i], 2) + pow(-x[1] + x[2*i + 1], 2)) <= delta[0]) ? (
   pow(pow(-x[0] + x[2*i], 2) + pow(-x[1] + x[2*i + 1], 2), -1.0L/2.0L)
)
: (
   0.0
));
...
K[2*j]+= 2*alpha[i - 1]*(-y[0] + y[2*i])*(-2*a_integ[0]*p_E[0]/(b_denom[0]*(2.0*p_nu[0] + 2.0)) + p_E[0]/(-6.0*p_nu[0] + 3.0))*((-x[0] + x[2*i])*(-y[0] + y[2*i])/(sqrt(pow(-x[0] + x[2*i], 2) + pow(-x[1] + x[2*i + 1], 2))*sqrt(pow(-y[0] + y[2*i], 2) + pow(-y[1] + y[2*i + 1], 2))) + (-x[1] + x[2*i + 1])*(-y[1] + y[2*i + 1])/(sqrt(pow(-x[0] + x[2*i], 2) + pow(-x[1] + x[2*i + 1], 2))*sqrt(pow(-y[0] + y[2*i], 2) + pow(-y[1] + y[2*i + 1], 2))))*(2*alpha[j - 1]*(-y[0] + y[2*j])*((-x[0] + x[2*j])*(-y[0] + y[2*j])/(sqrt(pow(-x[0] + x[2*j], 2) + pow(-x[1] + x[2*j + 1], 2))*sqrt(pow(-y[0] + y[2*j], 2) + pow(-y[1] + y[2*j + 1], 2))) + (-x[1] + x[2*j + 1])*(-y[1] + y[2*j + 1])/(sqrt(pow(-x[0] + x[2*j], 2) + pow(-x[1] + x[2*j + 1], 2))*sqrt(pow(-y[0] + y[2*j], 2) + pow(-y[1] + y[2*j + 1], 2))))*((sqrt(pow(-x[0] + x[2*j], 2) + pow(-x[1] + x[2*j + 1], 2)) <= delta[0]) ? (
   pow(pow(-x[0] + x[2*j], 2) + pow(-x[1] + x[2*j + 1], 2), -1.0L/2.0L)
)
: (
   0.0
...
void Oterkus2_rational_0_1_eval_wr(int l_edge, const real_t * restrict in, real_t * restrict out) {
   Oterkus2_rational_0_1_eval(l_edge,in, in+(int)(l_edge + 1), in+(int)(l_edge + 1)+(int)(1), in+(int)(l_edge + 1)+(int)(1)+(int)(1), in+(int)(l_edge + 1)+(int)(1)+(int)(1)+(int)(1), in+(int)(l_edge + 1)+(int)(1)+(int)(1)+(int)(1)+(int)(l_edge + 1), 
out, out+(int)(pow(l_edge + 1, 2)));
}

void kmap_Oterkus2_rational_0_10(int * edge, int l_edge, int * verts, int * n, int * dim) {
  int i;
  *dim = 2;
...
void kmap_Oterkus2_rational_0_11(int * edge, int l_edge, int * verts, int * n, int * dim) {
  int i;
  *dim = 1;
  *n = (int)((int)(1));
  if(edge) {
...
void kmap_Oterkus2_rational_0_12(int * edge, int l_edge, int * verts, int * n, int * dim) {
  int i;
  *dim = 1;
  *n = (int)((int)((1.0L/2.0L)*l_edge - 1.0L/2.0L));
  if(edge) {
...
kernel_t kernel_Oterkus2_rational_0_1 = {
.nmap = 3,
.maps = {
kmap_Oterkus2_rational_0_10,
kmap_Oterkus2_rational_0_11,
kmap_Oterkus2_rational_0_12
},
...
.eval=Oterkus2_rational_0_1_eval_wr,
.name="Oterkus2_rational_0_1"
};
