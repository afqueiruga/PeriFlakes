...
void BondBased_rational_1_2_eval(int l_edge,
/*Inputs:*/
...
void BondBased_rational_1_2_eval_wr(int l_edge, const real_t * restrict in, real_t * restrict out) {
   BondBased_rational_1_2_eval(l_edge,in, in+(int)(l_edge + 1), in+(int)(l_edge + 1)+(int)(1), in+(int)(l_edge + 1)+(int)(1)+(int)(1), in+(int)(l_edge + 1)+(int)(1)+(int)(1)+(int)(1), in+(int)(l_edge + 1)+(int)(1)+(int)(1)+(int)(1)+(int)(l_edge + 1), 
out, out+(int)(pow(l_edge + 1, 2)));
}

void kmap_BondBased_rational_1_20(int * edge, int l_edge, int * verts, int * n, int * dim) {
  int i;
  *dim = 2;
...
void kmap_BondBased_rational_1_21(int * edge, int l_edge, int * verts, int * n, int * dim) {
  int i;
  *dim = 1;
  *n = (int)((int)(1));
  if(edge) {
...
void kmap_BondBased_rational_1_22(int * edge, int l_edge, int * verts, int * n, int * dim) {
  int i;
  *dim = 1;
  *n = (int)((int)((1.0L/2.0L)*l_edge - 1.0L/2.0L));
  if(edge) {
...
kernel_t kernel_BondBased_rational_1_2 = {
.nmap = 3,
.maps = {
kmap_BondBased_rational_1_20,
kmap_BondBased_rational_1_21,
kmap_BondBased_rational_1_22
},
...
.eval=BondBased_rational_1_2_eval_wr,
.name="BondBased_rational_1_2"
};
