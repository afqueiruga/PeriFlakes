...
void smooth_cubic_eval(int l_edge,
/*Inputs:*/
...
void smooth_cubic_eval_wr(int l_edge, const real_t * restrict in, real_t * restrict out) {
   smooth_cubic_eval(l_edge,in, in+(int)(l_edge + 1), in+(int)(l_edge + 1)+(int)(1), in+(int)(l_edge + 1)+(int)(1)+(int)(l_edge + 1), 
out);
}

void kmap_smooth_cubic0(int * edge, int l_edge, int * verts, int * n, int * dim) {
  int i;
  *dim = 2;
...
void kmap_smooth_cubic1(int * edge, int l_edge, int * verts, int * n, int * dim) {
  int i;
  *dim = 1;
  *n = (int)((int)(1));
  if(edge) {
...
void kmap_smooth_cubic2(int * edge, int l_edge, int * verts, int * n, int * dim) {
  int i;
  *dim = 1;
  *n = (int)((int)((1.0L/2.0L)*l_edge - 1.0L/2.0L));
  if(edge) {
...
void kmap_smooth_cubic3(int * edge, int l_edge, int * verts, int * n, int * dim) {
  int i;
  *dim = 2;
  *n = (int)((int)(1));
  if(edge) {
