...
void Oterkus2_const_eval(int l_edge,
/*Inputs:*/
...
void Oterkus2_const_eval_wr(int l_edge, const real_t * restrict in, real_t * restrict out) {
   Oterkus2_const_eval(l_edge,in, in+(int)(l_edge + 1), in+(int)(l_edge + 1)+(int)(1), in+(int)(l_edge + 1)+(int)(1)+(int)(1), in+(int)(l_edge + 1)+(int)(1)+(int)(1)+(int)(1), in+(int)(l_edge + 1)+(int)(1)+(int)(1)+(int)(1)+(int)(l_edge + 1), 
out, out+(int)(pow(l_edge + 1, 2)));
}

void kmap_Oterkus2_const0(int * edge, int l_edge, int * verts, int * n, int * dim) {
  int i;
  *dim = 2;
...
void kmap_Oterkus2_const1(int * edge, int l_edge, int * verts, int * n, int * dim) {
  int i;
  *dim = 1;
  *n = (int)((int)(1));
  if(edge) {
...
void kmap_Oterkus2_const2(int * edge, int l_edge, int * verts, int * n, int * dim) {
  int i;
  *dim = 1;
  *n = (int)((int)((1.0L/2.0L)*l_edge - 1.0L/2.0L));
  if(edge) {
...
kernel_t kernel_Oterkus2_const = {
.nmap = 3,
.maps = {
kmap_Oterkus2_const0,
kmap_Oterkus2_const1,
kmap_Oterkus2_const2
},
